...
## Overview
This skill provides comprehensive access to the Outscore brand design system, including all UI tokens, color palettes, typography, spacing, shadows, gradients, and component styling patterns.
